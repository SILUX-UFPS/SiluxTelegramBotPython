...
db = MySQLdb.connect(host="", # tu host, generalmente localhost
                     user="", # nombre de usuario para la conexion a la base de datos
                      ...
                      db="", charset="") # nombre de la base de datos, se define codificacion utf-8
...
def correoB(correoBusqueda):
	print correoBusqueda
   	print datetime.datetime.now()
	cur.execute('SELECT nombre, correo FROM profesor where nombre like "%'+ correoBusqueda + '%"')
	print correoBusqueda
	row = ""
	correo = ""
